						...
						<div class="col-sm-12">
							<div class="row">
								...
								<div class="form-group">
	    							...
	    							<input type="email" class="form-control" id="inputEmail" placeholder="Enter Emailid" data-error="Bruh, that email address is invalid" name="emailid" value="<c:out value="${update.emailid}"/>" required>
	    							<div class="help-block with-errors"></div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="control-label">Password</label>
									<input type="password" minlength="6" pattern="^[_A-z0-9]{1,}$" maxlength="50"class="form-control" id="inputPassword" placeholder="Enter Password"  name="password"  value="<c:out value="${update.password}"/>"required>
	        						<div class="help-block">Minimum of 6 characters</div>
								</div>
								<div class="form-group">
									<label for="inputGender" class="control-label">Gender</label>
									<div class="radio">
										<label>	<input type="radio"  id="inputName" name="gender"  value="<c:out value="${update.gender}"/>" checked required >Male</label>
	    							</div>
	    							 <div class="radio">
	      								<label>	<input type="radio"  id="inputName" name="gender"  value="<c:out value="${update.gender}"/>" checked required >Female</label>
	    							</div>
	    						</div>
