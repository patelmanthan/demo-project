...
public class admin_update implements admin_update_int {
	
	public void admin_updatee(HttpServletRequest request){
		...
		admin_update_dao_int admin_update= new admin_update_dao();
		java.util.List<model> ls=admin_update.update(v);
