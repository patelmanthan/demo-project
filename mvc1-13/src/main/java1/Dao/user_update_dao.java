...
public class user_update_dao implements user_update_dao_int{
	/**
	 * Logger for this class
	 */
	private static final Logger logger = LogManager.getLogger(user_update_dao.class.getName());
	...
	public List<model> update(model v)
	{
		...
		try{
			...
			st.executeUpdate("update demo set fname='"+v.getFname()+"',mname='"+v.getMname()+"',lname='"+v.getLname()+"',gender='"+v.getGender()+"',language='"+v.getLanguage()+"',dob='"+v.getDob()+"',phonenumber='"+v.getPhonenumber()+"' where user_id='"+v.getUser_id()+"'");
