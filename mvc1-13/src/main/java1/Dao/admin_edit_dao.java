...
public class admin_edit_dao implements admin_edit_dao_int{
	/**
	 * Logger for this class
	 */
	private static final Logger logger = LogManager.getLogger(admin_edit_dao.class.getName());
	
	public List<model> edit(model v)
	{
